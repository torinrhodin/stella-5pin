document.addEventListener('presentationInit', function() {
	var slide = app.slide.efficacy_wAMD_gains = {
    elements: {
      tabFirst: "li.first",
      tabLast: "li.last",
    ...
    _tabFirstClick: function(event) {
      if (this.id != "wamd-gains-active") {
        document.getElementById('wamd-gains-active').id = "";
        this.id = "wamd-gains-active";
  		  document.getElementById('wamd-gains-first').style.display = "block";
  		  document.getElementById('wamd-gains-last').style.display = "none";
		  }
    },
    _tabLastClick: function(event) {
      if (this.id != "wamd-gains-active") {
        document.getElementById('wamd-gains-active').id = "";
        this.id = "wamd-gains-active";
  		  document.getElementById('wamd-gains-first').style.display = "none";
  		  document.getElementById('wamd-gains-last').style.display = "block";
  		}
    },
