document.addEventListener('presentationInit', function() {
	var slide = app.slide.efficacy_DME_response = {
    elements: {
      tabFirst: "li.first",
      tabLast: "li.last",
    ...
    _tabFirstClick: function(event) {
      if (this.id != "dme-response-active") {
        document.getElementById('dme-response-active').id = "";
        this.id = "dme-response-active";
  		  document.getElementById('dme-response-first').style.display = "block";
  		  document.getElementById('dme-response-last').style.display = "none";
		  }
    },
    _tabLastClick: function(event) {
      if (this.id != "dme-response-active") {
        document.getElementById('dme-response-active').id = "";
        this.id = "dme-response-active";
  		  document.getElementById('dme-response-first').style.display = "none";
  		  document.getElementById('dme-response-last').style.display = "block";
  		}
    },
